            ...
            <v-container  grid-list-lg>
                <v-layout column>
                    <v-flex  class="text-xs-center">
                        Si aún no registrado en Bogotá + Segura 
                        <v-btn flat to="/signup" class="blue--text darken-3">Ingresa aquí</v-btn>
                    </v-flex>
                </v-layout>
            </v-container>
        </v-container>
            ...
            <v-layout>
                <form @submit.prevent="signIn" class="col s12 text-center form_signup">
                    ...
                    <div class="input-field button_field">
                        <button class="btn lighten-1 z-depth-0">Iniciar Sesion</button>
                    </div>
                </form>
            </v-layout>
        </v-container>
